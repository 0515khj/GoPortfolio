...
import { TeamJoinWrap } from './teamInfoStyle';
        ...
        <TeamJoinWrap>
             <div className="inner">
                ...
                <div className="imageWrapper">
                  <img src={`${process.env.PUBLIC_URL}/assets/images/join.jpg`} alt="WBS 관련 이미지" />
                </div>
                ...
                <div className='info'>
                    ...
                    <ul>
                        <li>
                            <strong>이름, 이메일, 휴대폰번호, 비밀번호 입력</strong>
                            <p>이름, 이메일, 휴대폰번호, 비밀번호를 입력한 후 회원가입을 진행할 수 있습니다.</p>
                        </li>
                        <li>
